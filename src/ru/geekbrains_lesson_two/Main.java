...
//    Ќаписать метод, замен€ющий в прин€том массиве 0 на 1, 1 на 0;
...
//    }
//    2. «адать пустой целочисленный массив размером 8. Ќаписать метод, который помощью цикла заполнит его значени€ми
...
//   3. «адать массив [ 1, 5, 3, 2, 11, 4, 5, 2, 4, 8, 9, 1 ], написать метод, принимающий на вход массив и умножающий
//      числа меньше 6 на 2;
...
//}
//   4. «адать одномерный массив. Ќаписать методы поиска в нЄм минимального и максимального элемента;
...
//   5*. —оздать квадратный целочисленный массив (количество строк и столбцов одинаковое), заполнить его диагональные элементы
//       единицами, использу€ цикл(ы);
...
//  6** Ќаписать метод, в который передаетс€ не пустой одномерный целочисленный массив, метод должен вернуть true если в массиве
//    есть место, в котором сумма левой и правой части массива равны. ѕримеры: checkBalance([1, 1, 1, || 2, 1]) ? true,
//    checkBalance ([2, 1, 1, 2, 1]) ? false, checkBalance ([10, || 1, 2, 3, 4]) ? true. јбстрактна€ граница показана
//    символами ||, эти символы в массив не вход€т.
...
//  7***. Ќаписать метод, которому на вход подаЄтс€ одномерный массив и число n (может быть положительным, или отрицательным),
...
//    8*****.   Ќе пользоватьс€ вспомогательным массивом при решении задачи 7.
}
